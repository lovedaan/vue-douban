<template>
    <div id="in_theaters">
        <div class="list">
            <h2>{{topTitle}}</h2>
            <ul class="listItem">
                <router-link v-for="(item,index) in inTheatersData" :key="item.id" tag="li" :to="'/subject/'+item.id">
                    <a href="#">
                        <div class="leftItem">
            ...
            fetchData (){
                ...
                this.$jsonp({
                    ...
                    'success' : function (res) {
                        //console.log(res);
                        if(_this.inTheatersData.length == 0){
                            ...
                            var arr = _this.inTheatersData;
                            _this.inTheatersData = arr.concat(res.subjects);
